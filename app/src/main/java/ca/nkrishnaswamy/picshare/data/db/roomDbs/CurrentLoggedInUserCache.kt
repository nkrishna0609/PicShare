...
@Database(entities= [UserModel::class, UserPost::class], version = 9, exportSchema = false)
    ...
    companion object{
        ...
        fun getInstance(context: Context) : CurrentLoggedInUserCache {
            synchronized(this) {
                ...
                if (instance == null){
                    instance = Room.databaseBuilder(context.applicationContext, CurrentLoggedInUserCache::class.java, "currentLoggedInUserDbv9").addMigrations(
                        MIGRATION_8_9).build()
                    INSTANCE = instance
                }
                return instance
